...
lib.ssMetadata = [
		{name:"TEST2_atlas_1", frames: [[0,0,2014,1191]]},
		{name:"TEST2_atlas_2", frames: [[0,0,2014,1191]]},
		{name:"TEST2_atlas_3", frames: [[0,0,1375,951],[0,953,1375,951]]},
		{name:"TEST2_atlas_4", frames: [[0,0,1606,241],[0,243,500,500]]}
];
...
(lib.CachedBmp_11 = function() {
	this.initialize(ss["TEST2_atlas_4"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_5.setTransform(963.1,1771.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).to({state:[{t:this.instance_5},{t:this.instance_2},{t:this.instance_4}]},43).to({state:[]},1).wait(8));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_1821.jpg?1685194185872", id:"_1821"},
		{src:"images/greenblackboardbackgroundwithchalk.jpg?1685194185872", id:"greenblackboardbackgroundwithchalk"},
		{src:"images/TEST2_atlas_1.png?1685194185831", id:"TEST2_atlas_1"},
		{src:"images/TEST2_atlas_2.png?1685194185831", id:"TEST2_atlas_2"},
		{src:"images/TEST2_atlas_3.png?1685194185831", id:"TEST2_atlas_3"},
		{src:"images/TEST2_atlas_4.png?1685194185831", id:"TEST2_atlas_4"}
	],
	preloads: []
};
